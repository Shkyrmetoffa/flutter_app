...
class CertificateCheckScreenState extends State<CertificateCheckScreen> {
  ...
  _loadPdf() async {
    document = await PDFDocument.fromURL(filteredCertificates[0]
        .certificate_list
        .first
        .certificate_pdf
        .toString());
  ...
  Widget build(BuildContext context) {
    ...
    final certificateCheck = localized.data['${appLanguage.appLocal}CertificateCheck'].toUpperCase();
    final certCheckBold = localized.data['${appLanguage.appLocal}MobileCertCheckBold'];
    final certCheckText = localized.data['${appLanguage.appLocal}MobileCertCheckText'];
    final certCheckBtn = localized.data['${appLanguage.appLocal}CertificateCheckBtn'].toUpperCase();
    final certCheckIdNo = localized.data['${appLanguage.appLocal}MobileCertIdNo'];
    final certCheckStatus = localized.data['${appLanguage.appLocal}MobileCertStatus'];
    final certValidUntil = localized.data['${appLanguage.appLocal}MobileCertValidUntil'];
    final certOpenInPdf = localized.data['${appLanguage.appLocal}OpenInPdf'].toUpperCase();
    final certCheckNotFound = localized.data['${appLanguage.appLocal}CertCheckNotFound'];
    final certReportFraud = localized.data['${appLanguage.appLocal}ReportFraud2'].toUpperCase();
    final certCheckEmpty = localized.data['${appLanguage.appLocal}CertificateCheckEmpty'];
                        ...
                        ? Column(
                            ...
                            children: <Widget>[
                                Padding(
                                    ...
                                    child: Text(filteredCertificates[0].title,
                                        style: TextStyle(
                              ...
                              onPressed: () {
                                if (_formKey.currentState.validate()) {
                                  checkProcess = certificates
                                      .where((post) =>
                                          post.id_certificate.toString() == id)
                                      .toList();
